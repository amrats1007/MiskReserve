    ...
    <div className="space-y-6">
      ...
      <div className="glass-panel p-4 sm:p-6 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4 border border-[var(--stroke)] shadow-2xl">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-2xl bg-[rgba(125,169,255,0.1)] border border-[rgba(125,169,255,0.3)] text-[#7DA9FF]">
          ...
          <div>
            ...
            <p className="text-xs font-mono text-[#A2A7B3]">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleToday}
            className="px-3.5 py-1.5 rounded-xl bg-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.1)] border border-[var(--stroke)] text-[#7DA9FF] text-xs font-mono font-bold transition-all"
          >
            {t.filter.today}
          </button>
          
          <div className="flex items-center bg-[rgba(0,0,0,0.4)] p-1 rounded-xl border border-[var(--stroke)]">
            <button
              onClick={lang === 'ar' ? handleNextDay : handlePrevDay}
              className="p-1 rounded-lg hover:bg-[rgba(255,255,255,0.1)] text-[#A2A7B3] hover:text-white transition-all"
            >
      ...
      <div className="glass-panel rounded-3xl p-4 sm:p-6 border border-[var(--stroke)] overflow-x-auto shadow-2xl">
        <div className="min-w-[700px]">
          ...
          <div className="grid grid-cols-5 gap-3 pb-4 border-b border-[var(--stroke)]">
            {/* Time Column Header */}
            <div className="flex items-center justify-center p-3 rounded-2xl bg-[rgba(255,255,255,0.03)] text-xs font-mono font-bold text-[#A2A7B3] border border-[var(--stroke)]">
              <Clock className="w-3.5 h-3.5 text-[#7DA9FF] mr-1.5" />
            ...
            {rooms.map((room) => {
              ...
              return (
                <div
                  key={room.id}
                  className="p-3 rounded-2xl bg-[rgba(255,255,255,0.03)] border border-[var(--stroke)] text-center"
                >
                  ...
                  <div className="flex items-center justify-center gap-2 text-[10px] font-mono text-[#A2A7B3]">
                    <span>{loc}</span>
                    <span>•</span>
          ...
          <div className="divide-y divide-[var(--stroke)]">
            {HOURS.map((hour) => (
              <div key={hour} className="grid grid-cols-5 gap-3 py-2 items-stretch min-h-[75px]">
                ...
                {/* Hour Label */}
                <div className="flex items-center justify-center font-mono text-xs font-bold text-[#A2A7B3] bg-[rgba(255,255,255,0.02)] rounded-xl border border-[var(--stroke)]">
                  {hour}
                </div>
                ...
                {rooms.map((room) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between font-bold text-white mb-1">
                          ...
                          <span className="text-[10px] px-1.5 py-0.5 rounded bg-[rgba(0,0,0,0.6)] text-[#7DA9FF] font-mono border border-[var(--stroke)]">
                            {activeBooking.start_time.substring(0, 5)} - {activeBooking.end_time.substring(0, 5)}
                          </span>
                        </div>
                        <div className="text-[11px] text-[#A2A7B3]">
                          👤 {activeBooking.booker_name}
                        </div>
                        <div className="text-[10px] text-[#626772]">
                  ...
                  return (
                    <button
                      ...
                      className="group flex flex-col items-center justify-center p-2 rounded-xl border border-dashed border-[rgba(255,255,255,0.12)] hover:border-[#7DA9FF] bg-[rgba(255,255,255,0.01)] hover:bg-[rgba(125,169,255,0.06)] text-[#626772] hover:text-[#7DA9FF] transition-all text-xs"
                    >
