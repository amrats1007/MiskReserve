    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="glass-panel glass-panel-hover p-5 rounded-2xl border border-[var(--stroke)] relative overflow-hidden group shadow-xl">
        <div className="flex items-center justify-between relative z-10">
          <span className="font-mono text-[11px] font-semibold text-[var(--text-dim)] uppercase tracking-wider">{t.stats.totalBookings}</span>
          <div className="p-2.5 rounded-xl bg-[rgba(125,169,255,0.12)] text-[var(--blue)] border border-[rgba(125,169,255,0.3)]">
      ...
      <div className="glass-panel glass-panel-hover p-5 rounded-2xl border border-[var(--stroke)] relative overflow-hidden group shadow-xl">
        <div className="flex items-center justify-between relative z-10">
          <span className="font-mono text-[11px] font-semibold text-[var(--text-dim)] uppercase tracking-wider">{t.stats.activeToday}</span>
          <div className="p-2.5 rounded-xl bg-[rgba(74,222,128,0.12)] text-[var(--green)] border border-[rgba(74,222,128,0.3)]">
      ...
      <div className="glass-panel glass-panel-hover p-5 rounded-2xl border border-[var(--stroke)] relative overflow-hidden group shadow-xl">
        <div className="flex items-center justify-between relative z-10">
          <span className="font-mono text-[11px] font-semibold text-[var(--text-dim)] uppercase tracking-wider">{t.stats.busiestRoom}</span>
          <div className="p-2.5 rounded-xl bg-[rgba(167,139,250,0.12)] text-[var(--violet)] border border-[rgba(167,139,250,0.3)]">
      ...
      <div className="glass-panel glass-panel-hover p-5 rounded-2xl border border-[var(--stroke)] relative overflow-hidden group shadow-xl">
        <div className="flex items-center justify-between relative z-10">
          <span className="font-mono text-[11px] font-semibold text-[var(--text-dim)] uppercase tracking-wider">{t.stats.topEntity}</span>
          <div className="p-2.5 rounded-xl bg-[rgba(103,232,249,0.12)] text-[var(--cyan)] border border-[rgba(103,232,249,0.3)]">
