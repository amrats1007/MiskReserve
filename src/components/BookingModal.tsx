...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 overflow-y-auto">
      <div className="relative w-full max-w-3xl glass-panel rounded-3xl p-6 sm:p-8 border border-indigo-500/30 shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between pb-5 border-b border-slate-700/60">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-1">{t.modal.subtitle}</p>
          </div>
          <button
            onClick={onClose}
        ...
        {conflictWarning && (
          <div className="mt-4 p-4 rounded-2xl bg-amber-500/20 border border-amber-500/40 text-amber-200 text-sm flex items-start gap-3">
        ...
        {errorMessage && (
          <div className="mt-4 p-4 rounded-2xl bg-rose-500/20 border border-rose-500/40 text-rose-200 text-sm flex items-center gap-3">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6">
          ...
          {/* Date, Time & Attendees */}
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 p-4 rounded-2xl bg-slate-900/60 border border-slate-700/50">
            <div>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-700/60">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-bold shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
            >
              {submitting ? (
